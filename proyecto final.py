...
def par():
    ...
    if mascota== "gato":
        ...
        if raza== "labrador":
            print("la raza de gato elegida es labrador")
        if raza== "husky":
            print("la raza de gato elegida es husky")
        if raza== "criollo":
            print("la raza de gato elegida es criollo")
        if raza== "golden retriver":
            print("la raza de gato elegida es golden retriver")
