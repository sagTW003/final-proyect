...
def input_palabras(palabras):
    entrada=input(palabras)
    while not entrada.isalpha():
        print("Entrada invalida. Por favor ingrese un nombre valido")
        entrada =input(palabras)
    return str(entrada)
...
print("                                                        🐾 FUNDACIÓN KITTY PATITAS SUAVES   🐾                                          ")

time.sleep(1)
print("""\n 🎉 ¡Haz la diferencia con un acto de amor! 🐾\n
      

En KITTY PATITAS SUAVES, creemos que cada vida importa. Miles de perros y gatos esperan una segunda oportunidad, y tú puedes ser parte del cambio.

      
 💕No compres amor, adóptalo.
🤩 Adopta, salva una vida, gana un amigo fiel.

🐶🐱 Nos dedicamos a rescatar, proteger y dar en adopción a animales abandonados. Nuestro compromiso es crear conciencia, educar sobre tenencia responsable y construir un mundo donde ningún peludo sea dejado atrás.
      


      A continuación digite sus datos para registrarse y poder ayudarlo. 
     \n""")

time.sleep(1)
user = input_palabras("ingrese su nombre:")
